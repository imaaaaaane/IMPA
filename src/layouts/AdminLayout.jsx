...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#FAFAFA] text-gray-900 font-sans selection:bg-black selection:text-white">
      ...
      <aside className="w-64 bg-[#FAFAFA] border-r border-gray-100 flex flex-col fixed inset-y-0 z-20 print:hidden">
      ...
      <main className="flex-1 ml-64 print:ml-0 min-h-screen flex flex-col items-center">
        ...
        <header className="w-full max-w-6xl h-20 flex items-center justify-end px-8 print:hidden">
          <div className="flex items-center gap-3 cursor-pointer group">
            <div className="flex flex-col items-end">
              <span className="text-sm font-semibold text-gray-900 group-hover:text-black transition-colors">Admin User</span>
              <span className="text-xs text-gray-400 font-medium tracking-wide">Yönetici</span>
            </div>
            <div className="w-9 h-9 rounded-full bg-gray-100 border border-gray-200 flex items-center justify-center font-bold text-sm text-gray-600 group-hover:border-gray-300 transition-all">
              A
            </div>
          </div>
        </header>
        ...
        <div className="w-full max-w-6xl px-8 pb-12 print:px-0 print:pb-0 print:max-w-none flex-1 flex flex-col">
          <div className="flex-1 bg-white border border-gray-100 print:border-none rounded-2xl print:rounded-none shadow-sm print:shadow-none overflow-hidden flex flex-col">
            <Outlet />
          </div>
        </div>
      </main>
