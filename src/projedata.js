export const projectsData = [
    ...
    },
    {
        ...
        category: "MODÜLER MOBİLYA",
        type: "video",
        media: "/proje2.mp4",
        description: "Aydınlık ve ferah bir salon için tasarlanmış, doğal ahşap kaplamalı minimalist TV ünitesi ve orta sehpa konsepti. Zarif çizgiler, fonksiyonel depolama alanları ve ahşabın sıcak dokusu bir arada sunularak zamansız bir zarafet yakalandı."
    }
];